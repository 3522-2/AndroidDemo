...
public class Outaccountinfo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outaccountinfo);// 设置布局文件
        lvinfo = (ListView) findViewById(R.id.lvoutccountinfo);// 获取布局文件中的ListView组件
    ...
    private void ShowInfo(int intType) {// 用来根据传入的管理类型，显示相应的信息
        ...
        List<Tb_outaccount> listoutinfos = outaccountinfo.getScrollData
                (0, (int) outaccountinfo.getCount());
